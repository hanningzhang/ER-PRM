...
CUDA_VISIBLE_DEVICES=4 bash mc_reward_data_gsm.sh 4 0 &
CUDA_VISIBLE_DEVICES=5 bash mc_reward_data_gsm.sh 5 0 &
CUDA_VISIBLE_DEVICES=6 bash mc_reward_data_gsm.sh 6 0 &
CUDA_VISIBLE_DEVICES=7 bash mc_reward_data_gsm.sh 7 0 
