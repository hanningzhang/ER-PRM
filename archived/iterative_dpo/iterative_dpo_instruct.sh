...
base_dir="iterative_dpo_instruct_2e-7"
mkdir -p $base_dir
...
#   CUDA_VISIBLE_DEVICES=0 bash ./get_samples_instruct.sh ${old_model_dir} $((i - 1)) ${num_gpus} ${old_model_dir}/infer_set ${sanity_check} 0 ${random_seed} &
#   CUDA_VISIBLE_DEVICES=1 bash ./get_samples_instruct.sh ${old_model_dir} $((i - 1)) ${num_gpus} ${old_model_dir}/infer_set ${sanity_check} 1 ${random_seed} &
#   CUDA_VISIBLE_DEVICES=2 bash ./get_samples_instruct.sh ${old_model_dir} $((i - 1)) ${num_gpus} ${old_model_dir}/infer_set ${sanity_check} 2 ${random_seed} &
#   CUDA_VISIBLE_DEVICES=3 bash ./get_samples_instruct.sh ${old_model_dir} $((i - 1)) ${num_gpus} ${old_model_dir}/infer_set ${sanity_check} 3 ${random_seed} &
#   CUDA_VISIBLE_DEVICES=4 bash ./get_samples_instruct.sh ${old_model_dir} $((i - 1)) ${num_gpus} ${old_model_dir}/infer_set ${sanity_check} 4 ${random_seed} &
#   CUDA_VISIBLE_DEVICES=5 bash ./get_samples_instruct.sh ${old_model_dir} $((i - 1)) ${num_gpus} ${old_model_dir}/infer_set ${sanity_check} 5 ${random_seed} &
#   CUDA_VISIBLE_DEVICES=6 bash ./get_samples_instruct.sh ${old_model_dir} $((i - 1)) ${num_gpus} ${old_model_dir}/infer_set ${sanity_check} 6 ${random_seed} &
#   CUDA_VISIBLE_DEVICES=7 bash ./get_samples_instruct.sh ${old_model_dir} $((i - 1)) ${num_gpus} ${old_model_dir}/infer_set ${sanity_check} 7 ${random_seed} &
